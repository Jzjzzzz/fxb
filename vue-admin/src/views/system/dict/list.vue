<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-input v-model="searchObj.dictCode" placeholder="字典编码"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column label="操作" width="300" align="center">
        <template slot-scope="scope">
          <router-link :to="'/system/dict/dictData/'+scope.row.id" >
            <el-button type="warning" size="mini" icon="el-icon-edit" style="margin-right:10px" >列表</el-button>
          </router-link>
    ...
    <el-dialog @open="isDisabled=false" :before-close="onClearFrom" title="新增字典" :visible.sync="dialogVisible" width="30%">
      <el-form :model="form" :rules="rules"  ref="form">
        ...
        <el-form-item label="字典编码" :label-width="formLabelWidth"  prop="dictCode">
          <el-input type="text" v-model="form.dictCode" auto-complete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    //字典列表数据
    fetchData() {
      dictApi.listByTop(this.page,this.limit,this.searchObj)
      .then(response => {
